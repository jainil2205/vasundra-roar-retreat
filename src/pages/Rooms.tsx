          ...
          >
            ...
            <div className="bg-white rounded-xl shadow-md p-4 md:p-6">
              <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
                ...
                <div className="flex items-center gap-2 self-end md:self-auto">
                  <button 
                    ...
                    className="bg-green-50 hover:bg-green-100 text-green-700 px-4 py-2.5 rounded-lg transition-colors flex items-center gap-2"
                  >
                    <Sliders className="h-5 w-5" />
                    <span className="hidden sm:inline">Filters</span>
                    {(selectedAmenities.length > 0 || activeFilter !== "all" || guestCount > 1 || searchTerm) && (
                  ...
                  {/* Room Types Filter Pills */}
                  <div className="hidden md:flex gap-2">
                    {["all", "cottage", "villa", "retreat", "suite"].map((type) => (
                      <button
                        key={type}
              ...
              {showFilters && (
                <div 
                  ref={filtersRef}
                  className="mt-4 pt-4 border-t border-gray-200 grid grid-cols-1 md:grid-cols-3 gap-6"
                >
                  {/* Guest Count */}
                  <div>
                    ...
                    <div className="flex items-center">
                      <button
                        ...
                        className="bg-gray-100 hover:bg-gray-200 rounded-l-md px-3 py-2 text-gray-600"
                      >
                        -
                      </button>
                      <div className="bg-white border-t border-b border-gray-300 flex-1 text-center py-2">
                        {guestCount} {guestCount === 1 ? 'guest' : 'guests'}
                      </div>
                      <button
                        onClick={() => setGuestCount(guestCount + 1)}
                        className="bg-gray-100 hover:bg-gray-200 rounded-r-md px-3 py-2 text-gray-600"
                      >
                        +
                      </button>
                    </div>
                  ...
                  {/* Filter Actions */}
                  <div className="md:col-span-3 flex justify-between pt-3 border-t border-gray-200 mt-2">
                    <button
                    ...
                    <button
                      ...
                      className="bg-green-600 hover:bg-green-700 text-white px-4 py-1.5 rounded-lg transition-colors text-sm"
                    >
                      Apply Filters
                    </button>
                  </div>
